...
export default function AdminInvestorsPage() {
  ...
  const fetchVerifications = async () => {
    try {
      setLoading(true)
      const response = await fetch(`/api/auth/investor-verification?status=${statusFilter}`)
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div>
                                    ...
                                    <img
                                      src={selectedVerification.frontIdCardPath}
                                      alt="Front ID Card"
                                  ...
                                  <div>
                                    ...
                                    <img
                                      src={selectedVerification.backIdCardPath}
                                      alt="Back ID Card"
                                      className="w-full h-48 object-cover border rounded-lg"
                                    />
                                  </div>
